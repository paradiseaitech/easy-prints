...
export const NAV_ITEMS = [
  {
    ...
    children: [
      ...
      { label: "T-Shirts", href: "/custom-tshirt-printing" },
      { label: "Banners", href: "/banner-printing" },
      { label: "Flex Printing", href: "/flex-printing" },
      { label: "Brochures", href: "/brochure-printing" },
      { label: "Flyers", href: "/flyer-printing" },
      { label: "Stickers", href: "/sticker-printing" },
      { label: "Mugs", href: "/mug-printing" },
      { label: "Wedding Cards", href: "/wedding-card-printing" },
      { label: "Corporate Gifts", href: "/corporate-gifts" },
      { label: "Packaging", href: "/packaging-printing" },
      { label: "Photo Frames", href: "/photo-frames" },
      { label: "ID Cards", href: "/id-card-printing" },
      { label: "Posters", href: "/poster-printing" },
      { label: "Standees", href: "/standee-printing" },
    ],
  },
...
export const WHY_US = [
  ...
  },
  {
    icon: "Truck",
    title: "Fast Delivery",
    description: "Same-day and express delivery available across Purnia and Bihar.",
  },
  {
    icon: "Package",
    title: "Bulk Order Support",
    description: "Special pricing for bulk orders with consistent quality at scale.",
  },
  {
    icon: "IndianRupee",
    title: "Affordable Pricing",
    description: "Best price guarantee. High quality printing at factory-direct prices.",
  },
  {
    icon: "PenTool",
    title: "Design Assistance",
    description: "Expert designers help create or refine your artwork — free of charge.",
  },
  {
    icon: "Building2",
    title: "Trusted by Businesses",
    description: "500+ businesses across Bihar trust us for their printing needs.",
  },
]
